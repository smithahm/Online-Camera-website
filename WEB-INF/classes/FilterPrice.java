...
public class FilterPrice extends HttpServlet {
	...
	ResultSet resultSet2 = null;
        String first_val = request.getParameter("first_value");
	String second_val = request.getParameter("second_value");
	
	String query2 = null;
	Boolean found = false;
      
        String query = "SELECT sku,category.name,vendor.name,vendorModel,description,features,cost,retail,image from product,category,vendor WHERE retail > '"+first_val+"' AND retail <'"+second_val+"' AND category.categoryID = product.catID AND vendor.vendorID=product.venID";
