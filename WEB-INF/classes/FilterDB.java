...
public class FilterDB extends HttpServlet {
	...
	Boolean found = false;
        ...
        String query = "SELECT sku,category.name,vendor.name,vendorModel,description,features,cost,retail,image from product,category,vendor WHERE vendor.name LIKE '%" + search + "%' AND category.categoryID = product.catID AND vendor.vendorID=product.venID";
        String query2 = null;
