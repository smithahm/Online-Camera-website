...
public class CheckDSLR extends HttpServlet {
	...
	ResultSet resultSet2 = null;
        ...
        String query = "SELECT sku,category.name,vendor.name,vendorModel,description,features,cost,retail,image from product,category,vendor WHERE category.categoryID = product.catID AND vendor.vendorID=product.venID";
	String query2;
